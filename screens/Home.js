...
export default class HomeScreen extends React.Component{
    ...
    getMovie = () => {
        const url = "https://97a8bdc9a4d0.ngrok.io/get-movie"
        axios
    ...
    likedMovie = () => {
        const url = "https://97a8bdc9a4d0.ngrok.io/liked-movie"
        axios
        .post(url)
        .then((response) => {
            this.getMovie()
    ...
    unlikedMovie = () => {
        const url = "https://97a8bdc9a4d0.ngrok.io/unliked-movie"
        axios
        .post(url)
        .then((response) => {
            this.getMovie()
    ...
    notWatched = () => {
        const url = "https://97a8bdc9a4d0.ngrok.io/did-not-watch"
        axios
        .post(url)
        .then((response) => {
            this.getMovie()
